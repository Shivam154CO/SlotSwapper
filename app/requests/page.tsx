  ...
  const handleRequestSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.response?.status === 401) {
        ...
        setError('Failed to send swap request: ' + (err.response?.data?.message || err.message));
      }
    } finally {
      setSubmitting(false);
    }
    ...
    <ProtectedRoute>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="max-w-7xl mx-auto pt-20 px-4 pb-12">
              ...
              >
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-blue-600 text-sm mt-1">Please log in to manage swap requests</p>
                  </div>
                </div>
                <button 
          ...
          >
            {[
              { key: 'incoming', label: 'Incoming Requests', count: incomingRequests.length, icon: '📥' },
              { key: 'outgoing', label: 'My Requests', count: outgoingRequests.length, icon: '📤' },
              { key: 'request', label: 'Request Swap', count: availableEvents.length, icon: '🔄' }
            ].map((tab) => (
              <button
                key={tab.key}
            ...
            {!isLoggedIn && (
              <div className="p-8 text-center">
                <div className="bg-blue-50 rounded-2xl p-8 max-w-md mx-auto">
                  ...
                  <p className="text-gray-600 mb-6">Please log in to view and manage swap requests</p>
                  <button
                    onClick={handleLoginRedirect}
                    ...
                    {incomingRequests.length === 0 ? (
                      <div className="text-center py-16">
                        <div className="bg-blue-50 rounded-2xl p-8 max-w-md mx-auto">
                          ...
                          <p className="text-gray-600">When someone requests to swap your shifts, they'll appear here.</p>
                        </div>
                      </div>
                    ) : (
                      <div className="space-y-6">
                        {incomingRequests.map((request, index) => (
                          ...
                          >
                              ...
                              <div className="flex-1">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
                                  <div className="flex items-center">
                                    ...
                                    <span>By: {request.requesterName} ({request.requesterEmail})</span>
                                  </div>
                                  <div className="flex items-center">
                            ...
                            <div className="mb-4">
                              <p className="text-gray-700"><strong className="text-gray-900">Reason:</strong> {request.reason}</p>
                            </div>
                            ...
                            <div className="flex items-center justify-between text-sm text-gray-500">
                              <div className="flex items-center">
                                ...
                                Received: {formatDate(request.createdAt)} at {formatTime(request.createdAt)}
                              </div>
                    ...
                    {outgoingRequests.length === 0 ? (
                      <div className="text-center py-16">
                        <div className="bg-green-50 rounded-2xl p-8 max-w-md mx-auto">
                          ...
                          <p className="text-gray-600 mb-6">When you request to swap shifts, they'll appear here.</p>
                          <button
                      ...
                      <div className="space-y-6">
                        {outgoingRequests.map((request, index) => (
                          ...
                          >
                              ...
                              <div className="flex-1">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
                                  <div className="flex items-center">
                                    ...
                                    <span>Owner: {request.ownerName} ({request.ownerEmail})</span>
                                  </div>
                                  <div className="flex items-center">
                                    <svg className="w-4 h-4 mr-2 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                            ...
                            <div className="mb-4">
                              <p className="text-gray-700"><strong className="text-gray-900">Your Reason:</strong> {request.reason}</p>
                            </div>
                    ...
                    {availableEvents.length === 0 ? (
                      <div className="text-center py-16">
                        <div className="bg-orange-50 rounded-2xl p-8 max-w-md mx-auto">
                          ...
                          <h3 className="text-xl font-semibold text-gray-900 mb-2">No available events</h3>
                          <p className="text-gray-600">Check back later for swappable events.</p>
                        </div>
                      </div>
                    ) : (
